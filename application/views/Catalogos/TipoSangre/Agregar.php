<div class="contenedor-principal">
	<div class="titulo-principal shadow fondo">
		<div class="container contao ">
			<label>Catálogos: Tipo de Sangre / Agregar</label>
		</div>
	</div>
</div>
<br>
<div class="container">
	...
	<form class="validacionGeneral" action="<?=base_url('Catalogos/TipoSangre/Guardar')?>" method="POST"
		...
		<div class="form-group">
			...
			<input type="text" class="form-control required input-busqueda text-uppercase" required
				id="exampleFormControlInput1" name="nombre" placeholder="Escribir nombre del tipo de sangre">
		</div>

...
<div class="contenedor-principal">
	<div class="titulo-principal shadow fondo">
		<div class="container contao ">
			<label>Catálogos: Departamento | <label class="text-muted">NUEVA AREA DE <?=$departamento[0]['nombre']?></label>
		</div>
	</div>
</div>
<br>
<div class="container">
    ...
    <label class="page-container__title ">&nbsp;Catálogos: Departamento | <label class="text-muted">NUEVA AREA DE <?=$departamento[0]['nombre']?></label></label>
    <br>
    <a href="<?=base_url('Catalogos/Departamento/Areas/'.$departamento[0]['id'])?>" class="btn btn-azul"><i class="fa fa-plus" aria-hidden="true"></i> Regresar</a>

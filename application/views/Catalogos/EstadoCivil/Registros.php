...
<div class="contenedor-principal">
	<div class="titulo-principal shadow fondo">
		<div class="container contao ">
			<label>Catálogos: Estado Civil</label>
		</div>
	</div>
</div>
<br>
<div class="container">
	<a href="<?=base_url()?>Catalogos/EstadoCivil/Agregar" class="btn btn-azulclaro"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Estado Civil</a>
	<hr>

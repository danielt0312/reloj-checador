<div class="contenedor-principal">
	<div class="titulo-principal shadow fondo">
		<div class="container contao ">
			<label>Catálogos: Grado de Estudios / Editar</label>
		</div>
	</div>
</div>
<br>
<div class="container">
	...
	<form class="validacionGeneral" action="<?=base_url()?>Catalogos/GradosEstudios/Guardar/<?=$key['id']?>"
		method="POST" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
		<hr>
		<div class="form-group">
			...
			<input type="text" class="form-control required input-busqueda text-uppercase" required
				...
				placeholder="Escribir nombre del grado de estudio">
		</div>

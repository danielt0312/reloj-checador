...
<div class="contenedor-principal">
	<div class="titulo-principal shadow fondo">
		<div class="container contao ">
			<label>Catálogos: Grado de Estudios</label>
		</div>
	</div>
</div>
<br>
<div class="container">
	<a href="<?=base_url()?>Catalogos/GradosEstudios/Agregar" class="btn btn-azul"><i class="fa fa-plus"
			aria-hidden="true"></i> Agregar grado de estudios</a>
	<hr>
...
<div id="user-id" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form class="validacionGeneral" action="<?=base_url('Catalogos/GradosEstudios/Eliminar')?>" method="POST"
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var table = $('#example').DataTable({
			...
			'serverMethod': 'post',
			'ajax': {
				'url': '<?=base_url()?>Catalogos/GradosEstudios/Contenido',
				'type': "POST",
				'data': function (data) {

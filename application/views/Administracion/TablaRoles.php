...
<div class="container">
	...
	<label class="page-container__title ">&nbsp;Administración: Roles</label>
	<br>
  <a href="<?=base_url()?>Administracion/Roles/Agregar" class="btn btn-azul" >/ Agregar Rol</a>
<hr>
      ...
      var table = $('#example').DataTable(
        {
          ...
          'processing': true,
              ...
              'serverMethod': 'post',
              'ajax': {
                  'url':'<?=base_url()?>Administracion/Roles/Contenido',
                  'type': "POST",
                  'data':function(data) {
...
<div id="user-id" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form class="validacionGeneral" action="<?=base_url('Administracion/Roles/Eliminar')?>" method="POST" onKeypress="if(event.keyCode == 13) event.returnValue = false;">

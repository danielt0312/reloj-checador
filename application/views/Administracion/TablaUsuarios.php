...
<div class="container">
	...
	<label class="page-container__title ">&nbsp;Administración: Usuarios</label>
	<br>
  <a href="<?=base_url()?>Administracion/Usuarios/Agregar" class="btn btn-azul" ><i class="fa fa-plus" aria-hidden="true"></i> Agregar Usuario</a>
<hr>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <form class="form-inline"  method="post" >
                      ...
                      <div class="form-group">
                        <label for="todate" class="form-label">&emsp;Apellido paterno : </label>
                          <input type="text"  id="datepicker3" value="" class="form-control"  placeholder="" >
                      </div>
                      <div class="form-group">
                        <label for="todate" class="form-label">&emsp;Apellido materno : </label>
                          <input type="text"  id="datepicker4" value="" class="form-control"  placeholder="" >
                      </div>
                      <div class="form-group">
                        <label for="todate" class="form-label">&emsp;Correo : </label>
                          <input type="text"  id="datepicker5" value="" class="form-control"  placeholder="" >
                      </div>
                      <div class="form-group">
                        <label for="todate" class="form-label">&emsp;Rol : </label>
      ...
      var table = $('#example').DataTable(
        {
          ...
          'processing': true,
              ...
              'serverMethod': 'post',
              'ajax': {
                  'url':'<?=base_url()?>Administracion/Usuarios/Contenido',
                  'type': "POST",
                  'data':function(data) {
                    data.id = $('#datepicker1').val();
                    data.nombre = $('#datepicker2').val();
                    data.apellido_paterno = $('#datepicker3').val();
                    data.apellido_materno = $('#datepicker4').val();
                    data.correo = $('#datepicker5').val();
                    data.rol_id = $('#datepicker6').val();
                  },
              },
            'columns': [
                 { data: 'id' },
...
<div id="user-id" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form class="validacionGeneral" action="<?=base_url('Administracion/Usuarios/Eliminar')?>" method="POST" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
        <div class="modal-body">
              <div class="control-group">
                ...
                <br>
                        ...
                        <label>Correo:</label>
                        <input type="text" name="correo" class="form-control" id="correo" value=""/>
                        <label>Rol:</label>
                        <input type="text" name="rol_id" class="form-control" id="rol_id" value=""/>
...
$(document).on("click", ".datoselim", function () {
  ...
  var valor1=$(this).data('nombre');
  var valor2=$(this).data('apellido_paterno');
  var valor3=$(this).data('apellido_materno');
  var valor4=$(this).data('correo');
  var valor5=$(this).data('rol_id');
    $(".modal-body #idregistro").val(valorid);
    $(".modal-body #nombre").val(valor1);
    $(".modal-body #apellido_paterno").val(valor2);
    $(".modal-body #apellido_materno").val(valor3);
    $(".modal-body #correo").val(valor4);
    $(".modal-body #rol_id").val(valor5);
});
</script>

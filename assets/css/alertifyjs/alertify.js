...
( function ( window ) {
    ...
    var defaults = {
        ...
        theme:{
            input:'ajs-input',
            ok:'btn btn-primary',   /*Editado ajs-ok */
            cancel:'btn btn-cancel', /*Editado ajs-cancel */
        }
    };
    ...
    var dialog = (function () {
        var //holds the list of used keys.
            ...
            templates = {
                ...
                commands: '<div class="ajs-commands"><button class="ajs-pin"></button><button class="ajs-maximize"></div>',
                header: '<div class="ajs-header"></div>',
                body: '<div class="ajs-body"></div>',
                content: '<div class="ajs-content"></div>',
                footer: '<div class="ajs-footer"></div>',
                buttons: { primary: '<div class="ajs-primary ajs-buttons"></div>', auxiliary: '<div class="ajs-auxiliary ajs-buttons"></div>' },
                button: '<button class=""></button>',   /*Editado ajs-button*/
